...
if __name__ == "__main__":
    # train_loader, test_loader, database_loader, topk, num_classes = build_loader("D:/Data/Dataset",
    #                                                                              "flickr",
    #                                                                              128, 4)
    # for x in test_loader:
    #     print(x[0], x[1])
    trainset = torchvision.datasets.CIFAR10(root='/home/yuebai/Data/Dataset', train=True,download=True)
